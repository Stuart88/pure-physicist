...
namespace PurePhysicist.Views.Topics.ModernPhysics
{
    ...
    public partial class ContentsView : ContentView, ITopicPage, IPhysicistFetcher
    {
        ...
        public ContentsView(Color themeColour)
        {
            ...
            this.PageTitle = Constants.TopicTitles.ModernPhysics;

            this.BindingContext = this;

            this.PhysicistFetcher = new RandomPhysicistFetcher(TopicsEnum.ModernPhysics | TopicsEnum.NanoPhysics | TopicsEnum.NuclearPhysics);
